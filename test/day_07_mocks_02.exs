      ...
      "dim coral": %Day07.Node{
        ...
        childs: [
          "drab orange": %Day07.Node{
            ...
            childs: [
              "dim plum": %Day07.Node{
                bags: ["3 striped magenta bags", " 4 light teal bags",
                 " 4 dark salmon bags", " 5 drab orange bags."],
                childs: [],
                node: "dim plum",
                parent: "drab orange"
              },
              "bright crimson": %Day07.Node{
                bags: ["2 drab orange bags", " 1 drab lavender bag", " 3 dull black bags."],
                childs: [],
                node: "bright crimson",
                parent: "drab orange"
              }
